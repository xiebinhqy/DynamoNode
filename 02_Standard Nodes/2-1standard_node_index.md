...
>
* AdaptiveComponent.ByParametersOnCurveReference (parameters, curve, familyType)

* AdaptiveComponent.ByParametersOnFace (uvs, surface, familyType)

* AdaptiveComponent.ByPoints
* AdaptiveComponent.Locations
* AdaptiveComponent.Type
* AllFalse
* AllTrue
* AnalysisExtensions.IsAlmostEqualTo
* And
